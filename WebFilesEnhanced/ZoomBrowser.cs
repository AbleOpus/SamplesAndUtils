...
{
    public class ZoomBrowser : WebBrowser
    {
        private enum OleCmdID
        {
            OleCmdIDOpticalZoom = 63,
            OleCmdIDOpticalGetzoomrange = 64,
        }
        ...
        public void Zoom(int factor)
        {
            ...
            try
            {
                this.axIWebBrowser2.ExecWB(OleCmdID.OleCmdIDOpticalZoom,
                   Olecmdexecopt.OlecmdexecoptDontPromptUser,
